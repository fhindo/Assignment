...
const Form = () => {
    ...
    useEffect(() => {
        fetch("https://swapi.dev/api/vehicles")
            .then((response) => {
                ...
                console.log("The API vehicles respons console is ", response);
    ...
    //trying to capture the key form the obj
    // console.log("KEYS: ", Object.keys(starWarsApiInfo))
    // const optionsKeys = Object.keys(starWarsApiInfo)
